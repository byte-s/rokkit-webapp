      ...
      <div className={styles.blockCover}>
        ...
        <div className={styles.directionswrapper}>
          <DirectionItem type='1'>
            Поможем изменить дизайн существующего веб-сайта, интернет-магазина или веб-приложения, создать его с нуля или перенесите на другую платформу.
          </DirectionItem>
          <DirectionItem type='2'>
            Поможем улучшить показатели продаж, получать аналитику, и оптимизировать бизнес-процессы отделов с помощью современной CRM системы.
          </DirectionItem>
